  ...
  <property name="transitionGraph" class="Body">
    ...
    <steps class="ArrayList">
      <object class="Transition" serializationversion="3" id="3">
        ...
        <property name="stepAction" class="LoadPage2">
          <property name="urlProvider" class="kapow.robot.plugin.common.stepaction.urlprovider2.ValueURLProvider2">
            <property name="URL" class="String">library:/es6-sample.html</property>
          </property>
      ...
      <object class="Transition" serializationversion="3" id="4">
        <property name="name" class="String">Click promise生成!</property>
              ...
              <property name="dataConverters" class="DataConverters">
                <element class="ReplacePattern">
                  <property name="pattern" class="kapow.robot.plugin.common.support.expression.stringexpr.PartialInputMatchingPatternValueStringExpression">
                    <property name="value" class="String">&lt;script.*?&gt;</property>
                  </property>
                  <property name="replaceExp" class="String">&gt;&gt;&lt;script type="text/babel"&gt;&lt;&lt;</property>
                </element>
                <element class="ReplaceText">
                  <property name="textToReplace" class="String">&lt;/title&gt;
</property>
                  <property name="replacementText" class="String" id="5">&lt;/title&gt;
&lt;script src="https://unpkg.com/babel-standalone@6/babel.min.js"&gt;&lt;/script&gt;</property>
                </element>
              </property>
            </property>
        ...
        <property name="elementFinders" class="ElementFinders">
          <object class="DefaultNamedElementAwareDOMElementFinder" serializationversion="4">
            ...
            <property name="attributeValue" class="kapow.robot.plugin.common.support.predicate.unary.string.FixedStringPredicate">
              <property name="text" class="String">make-promise</property>
            </property>
          </object>
        </property>
        <property name="errorHandler" class="ErrorHandler" serializationversion="0"/>
  ...
  <property name="browserConfigurationSpecification" class="BrowserConfigurationSpecificationWebKit" serializationversion="26">
    <property name="language" class="kapow.robot.plugin.common.support.expression.stringexpr.PresetLanguageStringExpression">
      <property name="language" class="String">ja</property>
    </property>
    <property name="pagePreprocessingStringProcessorsSpecifier" class="kapow.robot.plugin.common.support.pagechange.AllURLBasedStringProcessorsProvider" serializationversion="0">
      <property name="dataConverters" class="DataConverters">
        <element class="ReplacePattern">
          ...
          <property name="replaceExp" class="String">contains($1, "text/javascript") ? 
    replaceText($0,$1,replaceText($1,"text/javascript","text/babel")) : 
    ( length($1) &gt; 1 ?
        replaceText($0,$1,$1 + &gt;&gt; type="text/babel"&lt;&lt;) :
        replaceText($0,"&gt;",&gt;&gt; type="text/babel"&gt;&lt;&lt;) )</property>
        </element>
        <element class="ReplaceText">
          <property name="textToReplace" class="String">&lt;/title&gt;</property>
          <property name="replacementText" idref="5"/>
        </element>
      </property>
    </property>
    <property name="javaScriptPolyfills" class="BeanList">
